...
namespace test.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, test.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((test.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public CourseEntityFactory() : base("CourseEntity", test.EntityType.CourseEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new CourseEntity(fields); }
	}

	/// <summary>Factory to create new, empty EnrollmentEntity objects.</summary>
	[Serializable]
	public partial class EnrollmentEntityFactory : EntityFactoryBase2<EnrollmentEntity> 
	{
		/// <summary>CTor</summary>
		public EnrollmentEntityFactory() : base("EnrollmentEntity", test.EntityType.EnrollmentEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new EnrollmentEntity(fields); }
	}

	/// <summary>Factory to create new, empty InstructorEntity objects.</summary>
	[Serializable]
	public partial class InstructorEntityFactory : EntityFactoryBase2<InstructorEntity> 
	{
		/// <summary>CTor</summary>
		public InstructorEntityFactory() : base("InstructorEntity", test.EntityType.InstructorEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new InstructorEntity(fields); }
	}
	...
	{
		/// <summary>CTor</summary>
		public StudentEntityFactory() : base("StudentEntity", test.EntityType.StudentEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(test.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(test.EntityType)))
			{
				var factory = GetFactory((test.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the test.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(test.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case test.EntityType.CourseEntity:
					return new CourseEntityFactory();
				case test.EntityType.EnrollmentEntity:
					return new EnrollmentEntityFactory();
				case test.EntityType.InstructorEntity:
					return new InstructorEntityFactory();
				case test.EntityType.StudentEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the test.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (test.EntityType)Enum.Parse(typeof(test.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((test.EntityType)Enum.Parse(typeof(test.EntityType), leftOperandEntityName, false), joinType, (test.EntityType)Enum.Parse(typeof(test.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (test.EntityType)Enum.Parse(typeof(test.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((test.EntityType)entityTypeValue); }
