...
namespace test.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((test.EntityType)typeOfEntity)
			{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting EnrollmentEntity instances in the database.</summary>
		public DataSource2<EnrollmentEntity> Enrollment {	get { return new DataSource2<EnrollmentEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting InstructorEntity instances in the database.</summary>
		public DataSource2<InstructorEntity> Instructor {	get { return new DataSource2<InstructorEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
